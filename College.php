...
$sql = "SELECT * FROM colleges WHERE city_name='$city'" . ($type ? " AND cat_name='$type'" : "");
...
<head>
    ...
    <title>City Explorer - Colleges</title>
    ...
    .college-map-link, .contact-list a {
      pointer-events: auto;
      cursor: pointer;
      position: relative;
      z-index: 2;
    }
    .listing-card *:not(.college-map-link):not(.contact-list a) {
      z-index: 2;
    }
    ...
    function filterTableByName() {
        ...
        if (cards.length) {
            cards.forEach(function(card) {
                var nameElem = card.querySelector(".college-title");
                if (!nameElem) return;
    ...
    <div class="listing-container">
        <?php foreach($records as $r): ?>
            <div class="listing-card-wrapper">
                <div class="listing-card" onclick="window.location.href='cdetails.php?id=<?php echo $r['id']; ?>'">
                    <a href="cdetails.php?id=<?= $r['id']; ?>" class="overlay-link" tabindex="-1" aria-label="More details"></a>
                    ...
                    <div class="listing-center">
                        <div class="college-title"><?php echo htmlspecialchars($r['name']); ?></div>
                        <div class="college-address-row">
                            <span class="college-address"><?php echo htmlspecialchars($r['address']); ?></span>
                            <a class="college-map-link" href="https://maps.google.com/?q=<?php echo urlencode($r['name']); ?>" target="_blank" onclick="event.stopPropagation();">View on Map</a>
                        </div>
                    ...
                    <div class="listing-right">
                        ...
                        <div class="field-row">
                            ...
                            <?php echo htmlspecialchars($r['courses']); ?>
                        </div>
                        <div class="field-row">
