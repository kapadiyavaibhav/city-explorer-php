...
$sql = "SELECT * FROM schools WHERE city_name='$city'" . ($type ? " AND cat_name='$type'" : "");
...
<head>
    ...
    <title>City Explorer - Schools</title>
    ...
    .school-map-link, .contact-list a {
      pointer-events: auto;
      cursor: pointer;
      position: relative;
      z-index: 2;
    }
    .listing-card *:not(.school-map-link):not(.contact-list a) {
      z-index: 2;
    }
    ...
    function filterTableByName() {
        ...
        if (cards.length) {
            cards.forEach(function(card) {
                var nameElem = card.querySelector(".school-title");
                if (!nameElem) return;
    ...
    <div class="listing-container">
        <?php foreach($records as $r): ?>
            <div class="listing-card-wrapper">
                <div class="listing-card" onclick="window.location.href='sdetails.php?id=<?php echo $r['id']; ?>'">
                    <a href="sdetails.php?id=<?= $r['id']; ?>" class="overlay-link" tabindex="-1" aria-label="More details"></a>
                    ...
                    <div class="listing-center">
                        <div class="school-title"><?php echo htmlspecialchars($r['name']); ?></div>
                        <div class="school-address-row">
                            <span class="school-address"><?php echo htmlspecialchars($r['address']); ?></span>
                            <a class="school-map-link" href="https://maps.google.com/?q=<?php echo urlencode($r['name']); ?>" target="_blank" onclick="event.stopPropagation();">View on Map</a>
                        </div>
                    ...
                    <div class="listing-right">
                        ...
                        <div class="field-row">
                            ...
                            <?php echo htmlspecialchars($r['grades']); ?>
                        </div>
