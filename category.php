...
<body>
  ...
  ?>
    ...
    <section class="categories-list">
      <h2>Discover Your City by Categories</h2>
...
{
?>
                <a href="<?php echo $fetch['cat_image'];?>.php?city=<?=$city?>&type=<?php echo $fetch['cat_name'];?>" class="category-card">
                    <div class="category-icon">
                    <img src="icons/cat/<?php echo $fetch['cat_image'];?>.svg";>
                    </div>
