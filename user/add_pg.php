...
if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO t_pgs ($fieldstr) VALUES ('$values')";
...
<input type="hidden" name="user_email" value="<?= htmlspecialchars($_SESSION['email']) ?>">
        ...
        <div class="yesno inline"><input type="checkbox" name="room_types[]" value="Single"> Single</div>
        <div class="yesno inline"><input type="checkbox" name="room_types[]" value="Double"> Double</div>
        <div class="yesno inline"><input type="checkbox" name="room_types[]" value="3 Sharing"> 3 Sharing</div>
        <div class="yesno inline"><input type="checkbox" name="room_types[]" value="AC"> AC</div>
        <div class="yesno inline"><input type="checkbox" name="room_types[]" value="Non AC"> Non AC</div>

        <div class="form-section">
            <label>Facilities <span class="small">(comma-separated)</span></label>
            <input type="text" name="facilities[]" value="" placeholder="Wi-Fi,Mess,Power Backup">
        </div>
        <div class="form-section">
        ...
        <div class="form-section">
            ...
            <input type="text" name="scholarships[]" value="" placeholder="Discount for Early Payment,Referral Bonus">
        </div>
        <div class="form-section">
