...
if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO t_colleges ($fieldstr) VALUES ('$values')";
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" id="collegeForm">
        ...
        <div class="form-section">
            ...
            <input type="text" name="courses[]" value="" placeholder="B.Tech,MBA,B.Sc">
        </div>
        <div class="form-section">
            <label>Departments <span class="small">(comma-separated)</span></label>
            <input type="text" name="departments[]" value="" placeholder="Computer Science,Mechanical,Physics">
        </div>
        <div class="form-section">
            <label>Facilities <span class="small">(comma-separated)</span></label>
            <input type="text" name="facilities[]" value="" placeholder="Auditorium,Medical,ATM">
        </div>
        <div class="form-section">
            <label>Faculty</label>
            <div id="faculty">
