...
$table_pending = "t_colleges";
$table_final   = "colleges";
...
if (isset($_GET['approve'])) {
    ...
    if ($row = mysqli_fetch_assoc($res)) {
        unset($row['id']); // let AUTO_INCREMENT handle it
...
<body>
<div class="container">
    <h2><?= $editing ? "Edit Pending College" : "Add Pending College" ?></h2>
