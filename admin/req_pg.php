...
if (isset($_GET['approve'])) {
    ...
    if ($row = mysqli_fetch_assoc($res)) {
        unset($row['id']); // let final table generate new id
        ...
        $msg = "Record approved and moved to final!";
    }
}
...
if (isset($_POST['save'])) {
    ...
    if ($id) {
        ...
        mysqli_query($conn, $sql);
        $msg = "Pending record updated successfully!";
...
<body>
<div class="container">
    <h2><?= $editing ? "Edit Pending P.G." : "Add Pending P.G." ?></h2>

    <!-- keep your full form here (unchanged, same as original) -->
...
<label>Room Types</label>
    ...
    ?>
    <!-- I only replaced backend table handling, so form fields remain identical -->
