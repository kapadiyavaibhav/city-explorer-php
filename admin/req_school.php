...
if (isset($_GET['approve'])) {
    ...
    if ($row = mysqli_fetch_assoc($res)) {
        unset($row['id']); // let AUTO_INCREMENT handle new id
...
<body>
<div class="container">
    <h2><?= $editing ? "Edit Pending School" : "Add Pending School" ?></h2>
